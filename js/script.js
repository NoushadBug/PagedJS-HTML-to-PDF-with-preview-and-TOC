...
window.addEventListener('load', async () => {
  ...
  <header id="header-pagedjs">\
    <div id="header-container">\
        ...
        <button id="button-screen" data-text="Web version">' + iconScreen + '</button>\
        <button id="button-print-preview" data-text="View as Printable Page">' + iconBook + '</button>\
        <button id="button-print" data-text="Print">' + iconPrinter + '</button>\
    </div>\
    </header>\
